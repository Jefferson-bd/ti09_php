...
<html lang="pt-br">
    ...
    <main class="container">
        ...
        <table class="table-hover table-condensed tbopacidade">
            <!-- thead>tr>th*8 -->
            <thead><!-- cabeçalho da tabela -->
                <tr>
                    ...
                    <th>IMAGEM</th>
                    <th>
                        <a href="produtos_insere.php" target="_self" class="btn btn-block btn-success">
            ...
            <tbody><!-- corpo da tabela -->
                ...
                <tr><!-- Linha da tabela -->
                    ...
                    <!-- vírgula >> 0,00 >> separador decimais -->
                    ...
                    <td>
                    <a href="produtos_atualiza.php?id_produto=<?php echo $row['id_produto']; ?>" target="_self" class="btn btn-info btn-block btn-xs" role="button">
